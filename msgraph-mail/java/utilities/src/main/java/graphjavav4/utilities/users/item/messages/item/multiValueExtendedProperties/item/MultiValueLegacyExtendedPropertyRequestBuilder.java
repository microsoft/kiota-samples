...
public class MultiValueLegacyExtendedPropertyRequestBuilder {
     ...
     * @return a void
     */
    public MultiValueLegacyExtendedPropertyRequestBuilder(@javax.annotation.Nonnull final HashMap<String, String> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
