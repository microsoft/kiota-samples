...
namespace KiotaSamples.PetStoreSdk.Store.Order.Item {
    /// <summary>Builds and executes requests for operations under \store\order\{orderId}</summary>
    public class WithOrderItemRequestBuilder {
        ...
        /// </summary>
        public WithOrderItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreateDeleteRequestInformation(Action<WithOrderItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<WithOrderItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            var requestInfo = new RequestInformation {
        ...
        /// </summary>
        public async Task<Stream> DeleteAsync(Action<WithOrderItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<KiotaSamples.PetStoreSdk.Models.Order> GetAsync(Action<WithOrderItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
