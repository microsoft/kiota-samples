...
module Graphrubyv4::Utilities::Users::MailFolders::Messages::MultiValueExtendedProperties
    ## 
    ...
    class MultiValueExtendedPropertiesRequestBuilder
        ...
        @path_segment
        ## 
        # Gets an item from the graphrubyv4.utilities.users.mailFolders.messages.multiValueExtendedProperties collection
        def [](position)
