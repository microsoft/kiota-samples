...
public class ChildFoldersRequestBuilder {
     ...
     * @return a void
     */
    public ChildFoldersRequestBuilder(final String currentPath, final RequestAdapter requestAdapter) {
     ...
     * @return a void
     */
    public ChildFoldersRequestBuilder(@javax.annotation.Nonnull final String currentPath, @javax.annotation.Nonnull final RequestAdapter requestAdapter, final boolean isRawUrl) {
