...
export class MultiValueLegacyExtendedPropertyRequestBuilder {
     ...
     * @returns a RequestInfo
     */
    public createPatchRequestInfo(body: MultiValueLegacyExtendedProperty | undefined, h?: object | undefined) : RequestInfo {
        const requestInfo = new RequestInfo();
        requestInfo.URI = (this.currentPath ?? '') + this.pathSegment,
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: MultiValueLegacyExtendedProperty | undefined, h?: object | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
