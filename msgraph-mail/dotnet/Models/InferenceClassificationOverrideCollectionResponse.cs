...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Graphdotnetv4.Models.InferenceClassificationOverride>? Value { get; set; }
#nullable restore
#else
        public List<Graphdotnetv4.Models.InferenceClassificationOverride> Value { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="Graphdotnetv4.Models.InferenceClassificationOverrideCollectionResponse"/> and sets the default values.
        /// </summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "value", n => { Value = n.GetCollectionOfObjectValues<Graphdotnetv4.Models.InferenceClassificationOverride>(Graphdotnetv4.Models.InferenceClassificationOverride.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Graphdotnetv4.Models.InferenceClassificationOverride>("value", Value);
