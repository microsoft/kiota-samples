...
namespace Graphdotnetv4.Users.Item.Messages.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the Graphdotnetv4.users.item.messages.item.attachments.item collection</summary>
        ...
        /// </summary>
        public async Task<AttachmentsResponse> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
