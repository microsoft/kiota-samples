...
namespace Microsoft\Graph\Users\Messages;

use Microsoft\Graph\Users\Message;
use Microsoft\Graph\Users\Messages\Item\MessageRequestBuilder;
...
class MessagesRequestBuilder 
{
    ...
    */
    public function get(GetQueryParameters $q, array $headers, array $options, ResponseHandlerInterface $responseHandler): ?MessagesResponse {
    }
     ...
     * @return Message|null
    */
    public function post(?Message $body, array $headers, array $options, ResponseHandlerInterface $responseHandler): ?Message {
    }
