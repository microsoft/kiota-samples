...
child_folders_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.child_folders.child_folders_request_builder')
mail_folder_item_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.child_folders.item.mail_folder_item_request_builder')
message_rules_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.message_rules.message_rules_request_builder')
message_rule_item_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.message_rules.item.message_rule_item_request_builder')
messages_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.messages.messages_request_builder')
message_item_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.messages.item.message_item_request_builder')
multi_value_extended_properties_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.multi_value_extended_properties.multi_value_extended_properties_request_builder')
multi_value_legacy_extended_property_item_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.multi_value_extended_properties.item.multi_value_legacy_extended_property_item_request_builder')
single_value_extended_properties_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.single_value_extended_properties.single_value_extended_properties_request_builder')
single_value_legacy_extended_property_item_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.single_value_extended_properties.item.single_value_legacy_extended_property_item_request_builder')
