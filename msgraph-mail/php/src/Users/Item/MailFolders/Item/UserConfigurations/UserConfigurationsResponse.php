...
class UserConfigurationsResponse implements Parsable 
{
    ...
    /** @var array<UserConfiguration>|null $value  */
    private ?array $value;
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            '@odata.nextLink' => function (UserConfigurationsResponse $o, string $n) { $o->setNextLink($n); },
            'value' => function (UserConfigurationsResponse $o, array $n) { $o->setValue($n); },
        ];
    }
