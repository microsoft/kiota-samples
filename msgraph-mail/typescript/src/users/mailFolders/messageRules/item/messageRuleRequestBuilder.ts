...
export class MessageRuleRequestBuilder {
    ...
    public patch (body: MessageRule, h?: object | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Entity | undefined> {
    ...
    public createPatchRequestInfo (body: MessageRule, h?: object | undefined) : RequestInfo {
        const requestInfo = new RequestInfo();
        requestInfo.URI = (this.currentPath ?? '') + this.pathSegment,
