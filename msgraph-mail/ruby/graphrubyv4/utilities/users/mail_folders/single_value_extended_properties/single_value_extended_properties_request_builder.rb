...
module Graphrubyv4::Utilities::Users::MailFolders::SingleValueExtendedProperties
    ## 
    ...
    class SingleValueExtendedPropertiesRequestBuilder
        ...
        @path_segment
        ## 
        # Gets an item from the graphrubyv4.utilities.users.mailFolders.singleValueExtendedProperties collection
        def [](position)
