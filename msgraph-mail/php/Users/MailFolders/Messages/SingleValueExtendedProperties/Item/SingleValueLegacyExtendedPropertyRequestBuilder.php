...
namespace Microsoft\Graph\Users\MailFolders\Messages\SingleValueExtendedProperties\Item;
...
class SingleValueLegacyExtendedPropertyRequestBuilder 
{
    ...
    */
    public function get(GetQueryParameters $q, array $headers, array $options, ResponseHandlerInterface $responseHandler): ?SingleValueLegacyExtendedProperty {
    }
     ...
     * @param ResponseHandlerInterface|null $responseHandler $responseHandler Response handler to use in place of the default response handling provided by the core service
    */
    public function patch(?SingleValueLegacyExtendedProperty $body, array $headers, array $options, ResponseHandlerInterface $responseHandler): void {
    }
