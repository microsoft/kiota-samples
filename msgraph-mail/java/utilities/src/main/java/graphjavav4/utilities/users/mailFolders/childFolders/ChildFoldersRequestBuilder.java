...
public class ChildFoldersRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public <U extends MailFolder> RequestInfo createPostRequestInfo(@javax.annotation.Nonnull final U body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public <U extends MailFolder> RequestInfo createPostRequestInfo(@javax.annotation.Nonnull final U body, @javax.annotation.Nullable final java.util.function.Consumer<Map<String, String>> h) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInfo requestInfo = new RequestInfo() {{
            uri = new URI(currentPath + pathSegment);
            httpMethod = HttpMethod.POST;
    ...
    /**
     * Get childFolders from users
     * @param <U> The generic type for the model, must inherit ChildFoldersResponse
     * @return a CompletableFuture of ChildFoldersResponse
     */
    public <U extends ChildFoldersResponse> java.util.concurrent.CompletableFuture<U> get() {
        try {
     ...
     * @return a CompletableFuture of ChildFoldersResponse
     */
    public <U extends ChildFoldersResponse> java.util.concurrent.CompletableFuture<U> get(@javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInfo requestInfo = createGetRequestInfo(
            );
     ...
     * @return a CompletableFuture of ChildFoldersResponse
     */
    public <U extends ChildFoldersResponse> java.util.concurrent.CompletableFuture<U> get(@javax.annotation.Nullable final java.util.function.Consumer<Map<String, String>> h, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInfo requestInfo = createGetRequestInfo(
                h
            );
     ...
     * @return a CompletableFuture of ChildFoldersResponse
     */
    public <U extends ChildFoldersResponse> java.util.concurrent.CompletableFuture<U> get(@javax.annotation.Nullable final java.util.function.Consumer<GetQueryParameters> q, @javax.annotation.Nullable final java.util.function.Consumer<Map<String, String>> h, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInfo requestInfo = createGetRequestInfo(
                q, h
            );
     ...
     */
    public <U extends MailFolder> java.util.concurrent.CompletableFuture<U> post(@javax.annotation.Nonnull final U body) {
        Objects.requireNonNull(body);
        try {
     ...
     * @return a CompletableFuture of MailFolder
     */
    public <U extends MailFolder> java.util.concurrent.CompletableFuture<U> post(@javax.annotation.Nonnull final U body, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInfo requestInfo = createPostRequestInfo(
                body
     ...
     * @return a CompletableFuture of MailFolder
     */
    public <U extends MailFolder> java.util.concurrent.CompletableFuture<U> post(@javax.annotation.Nonnull final U body, @javax.annotation.Nullable final java.util.function.Consumer<Map<String, String>> h, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInfo requestInfo = createPostRequestInfo(
                body, h
