param(
  ...
  [String]
  $AppName = "Kiota ToDoItem Sample API TypeScript Client",
...
$clientIdLine = "export const CLIENT_ID = '" + $appRegistration.AppId + "';"
$tenantIdLine = "export const TENANT_ID = '" + $context.TenantId + "';"
$scopesLine = "export const API_SCOPE = '" + $ApiScopePlaceHolder + "';"
