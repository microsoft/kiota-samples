...
namespace Graphdotnetv4.Users.InferenceClassification.Overrides.Item {
    ...
    public class InferenceClassificationOverrideRequestBuilder {
        ...
        /// </summary>
        public InferenceClassificationOverrideRequestBuilder(string currentPath, IHttpCore httpCore) {
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInfo CreatePatchRequestInfo(InferenceClassificationOverride body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
