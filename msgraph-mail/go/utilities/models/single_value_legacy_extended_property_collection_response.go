...
func (m *SingleValueLegacyExtendedPropertyCollectionResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["@odata.nextLink"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        return core.SetValue(n.GetStringValue , m.SetOdataNextLink)
    }
    res["value"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        return core.SetCollectionValue(n.GetCollectionOfObjectValues , CreateSingleValueLegacyExtendedPropertyFromDiscriminatorValue , m.SetValue)
    }
    return res
}
