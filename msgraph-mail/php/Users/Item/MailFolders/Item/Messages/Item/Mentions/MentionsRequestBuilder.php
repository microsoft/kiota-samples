...
namespace Microsoft\Graph\Users\Item\MailFolders\Item\Messages\Item\Mentions;

use Microsoft\Graph\Models\Microsoft\Graph\Mention;
use Microsoft\Graph\Users\Item\MailFolders\Item\Messages\Item\Mentions\Item\MentionRequestBuilder;
...
class MentionsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = 'https://graph.microsoft.com/beta/users/{user_id}/mailFolders/{mailFolder_id}/messages/{message_id}/mentions{?top,skip,search,filter,count,orderby,select,expand}';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(Mention $body, ?array $headers, ?array $options): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
