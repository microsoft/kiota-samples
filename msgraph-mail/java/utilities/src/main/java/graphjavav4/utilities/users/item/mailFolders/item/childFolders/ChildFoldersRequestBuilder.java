...
public class ChildFoldersRequestBuilder {
     ...
     * @return a void
     */
    public ChildFoldersRequestBuilder(@javax.annotation.Nonnull final String rawUrl, final RequestAdapter requestAdapter) {
     ...
     * @return a void
     */
    public ChildFoldersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, String> urlTemplateParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<ChildFoldersResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, ChildFoldersResponse.class, null);
