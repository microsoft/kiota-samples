...
module Graphrubyv4::Users::Item::Messages::Item::Extensions
    ...
    class ExtensionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter) 
            @url_template = "https://graph.microsoft.com/v1.0/users/{user_id}/messages/{message_id}/extensions{?top,skip,search,filter,count,orderby,select,expand}"
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::Messages::Item::Extensions::ExtensionsResponse, response_handler)
        end
        ## 
        ## The collection of open extensions defined for the message. Nullable.
        ## @param body 
