...
namespace Graphdotnetv4.Users.MailFolders.MessageRules.Item {
    ...
    public class MessageRuleRequestBuilder {
        ...
        /// </summary>
        public RequestInfo CreatePatchRequestInfo<T>(T body, Action<IDictionary<string, string>> h = default) where T : MessageRule, IParsable<T>, new(){
            var requestInfo = new RequestInfo {
        ...
        /// <typeparam name="T">The generic type for the model, must inherit MessageRule</typeparam>
        /// </summary>
        public async Task<T> GetAsync<T>(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IResponseHandler responseHandler = default) where T : MessageRule, IParsable<T>, new(){
        ...
        /// <typeparam name="T">The generic type for the model, must inherit MessageRule</typeparam>
        /// </summary>
        public async Task PatchAsync<T>(T body, Action<IDictionary<string, string>> h = default, IResponseHandler responseHandler = default) where T : MessageRule, IParsable<T>, new(){
