        ...
        class SingleValueLegacyExtendedPropertyCollectionResponse
            ...
            def get_field_deserializers()
                return {
                    ...
                    "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| Graphrubyv4::Models::SingleValueLegacyExtendedProperty.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
