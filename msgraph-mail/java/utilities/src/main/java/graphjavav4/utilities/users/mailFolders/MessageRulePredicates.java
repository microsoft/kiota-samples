...
public class MessageRulePredicates implements Parsable {
    ...
    private List<String> _bodyOrSubjectContains;
    /** Represents the categories that an incoming message should be labeled with in order for the condition or exception to apply.  */
    private List<String> _categories;
    /** Represents the specific sender email addresses of an incoming message in order for the condition or exception to apply.  */
    private List<Recipient> _fromAddresses;
    /** Indicates whether an incoming message must have attachments in order for the condition or exception to apply.  */
    private Boolean _hasAttachments;
    /** Represents the strings that appear in the headers of an incoming message in order for the condition or exception to apply.  */
    private List<String> _headerContains;
    ...
    private List<String> _recipientContains;
    /** Represents the strings that appear in the from property of an incoming message in order for the condition or exception to apply.  */
    private List<String> _senderContains;
    ...
    private List<Recipient> _sentToAddresses;
    ...
    private List<String> _subjectContains;
     ...
     * @return a void
     */
    public void setBodyContains(@javax.annotation.Nullable final List<String> value) {
     ...
     * @return a void
     */
    public void setBodyOrSubjectContains(@javax.annotation.Nullable final List<String> value) {
     ...
     * @return a void
     */
    public void setFromAddresses(@javax.annotation.Nullable final List<Recipient> value) {
     ...
     * @return a void
     */
    public void setHeaderContains(@javax.annotation.Nullable final List<String> value) {
     ...
     * @return a void
     */
    public void setRecipientContains(@javax.annotation.Nullable final List<String> value) {
     ...
     * @return a void
     */
    public void setSenderContains(@javax.annotation.Nullable final List<String> value) {
     ...
     * @return a void
     */
    public void setSentToAddresses(@javax.annotation.Nullable final List<Recipient> value) {
     ...
     * @return a void
     */
    public void setSubjectContains(@javax.annotation.Nullable final List<String> value) {
