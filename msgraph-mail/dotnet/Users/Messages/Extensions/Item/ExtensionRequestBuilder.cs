...
namespace Graphdotnetv4.Users.Messages.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        /// </summary>
        public ExtensionRequestBuilder(string currentPath, IHttpCore httpCore) {
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInfo CreatePatchRequestInfo(Extension body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
