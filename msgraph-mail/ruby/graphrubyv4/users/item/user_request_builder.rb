...
module Graphrubyv4::Users::Item
    ...
    class UserRequestBuilder
        ...
        def inference_classification()
            return Graphrubyv4::Users::InferenceClassification::InferenceClassificationRequestBuilder.new(@current_path + @path_segment , @http_core, false)
        end
        ## 
        # Whether the current path is a raw URL
        @is_raw_url
        def mail_folders()
            return Graphrubyv4::Users::MailFolders::MailFoldersRequestBuilder.new(@current_path + @path_segment , @http_core, false)
        end
        def messages()
            return Graphrubyv4::Users::Messages::MessagesRequestBuilder.new(@current_path + @path_segment , @http_core, false)
        end
        ## 
        ...
        def mail_folders_by_id(id) 
            return Graphrubyv4::Users::MailFolders::Item::MailFolderRequestBuilder.new(@current_path + @path_segment  + "/mailFolders/" + id, @http_core, false)
        end
        ## 
        ...
        def messages_by_id(id) 
            return Graphrubyv4::Users::Messages::Item::MessageRequestBuilder.new(@current_path + @path_segment  + "/messages/" + id, @http_core, false)
        end
    end
end
