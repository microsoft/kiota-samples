...
namespace Microsoft\Graph\Users\MailFolders\Messages\Item;

use Microsoft\Graph\Users\MailFolders\Messages\Attachments\AttachmentsRequestBuilder;
use Microsoft\Graph\Users\MailFolders\Messages\Content\ContentRequestBuilder;
use Microsoft\Graph\Users\MailFolders\Messages\Extensions\ExtensionsRequestBuilder;
use Microsoft\Graph\Users\MailFolders\Messages\MultiValueExtendedProperties\MultiValueExtendedPropertiesRequestBuilder;
use Microsoft\Graph\Users\MailFolders\Messages\SingleValueExtendedProperties\SingleValueExtendedPropertiesRequestBuilder;
...
class MessageRequestBuilder 
{
    ...
    /**
     * Gets an item from the Microsoft\Graph.users.mailFolders.messages.attachments collection
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph.users.mailFolders.messages.extensions collection
     * @param ?String $id $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph.users.mailFolders.messages.multiValueExtendedProperties collection
     * @param ?String $id $id Unique identifier of the item
    ...
    */
    ...
    /**
     * Gets an item from the Microsoft\Graph.users.mailFolders.messages.singleValueExtendedProperties collection
     * @param ?String $id $id Unique identifier of the item
