...
public class SingleValueLegacyExtendedPropertyRequestBuilder {
     ...
     * @return a void
     */
    public SingleValueLegacyExtendedPropertyRequestBuilder(final String currentPath, final RequestAdapter requestAdapter) {
     ...
     * @return a void
     */
    public SingleValueLegacyExtendedPropertyRequestBuilder(@javax.annotation.Nonnull final String currentPath, @javax.annotation.Nonnull final RequestAdapter requestAdapter, final boolean isRawUrl) {
