...
module Graphrubyv4::Utilities::Users::MailFolders::Messages::SingleValueExtendedProperties
    ## 
    ...
    class SingleValueExtendedPropertiesRequestBuilder
        ...
        @path_segment
        ## 
        # Gets an item from the graphrubyv4.utilities.users.mailFolders.messages.singleValueExtendedProperties collection
        def [](position)
