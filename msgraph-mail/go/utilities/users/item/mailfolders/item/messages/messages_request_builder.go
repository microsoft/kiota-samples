...
// CreatePostRequestInformationWithRequestConfiguration the collection of messages in the mailFolder.
...
// PostWithResponseHandler the collection of messages in the mailFolder.
