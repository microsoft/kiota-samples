...
func (m *MessageRequestBuilder) Attachments()(i3a8d456234d570904652042e0d4c0c5c4510aca0788f80c075c5daa8f534b477.AttachmentsRequestBuilder) {
    return *i3a8d456234d570904652042e0d4c0c5c4510aca0788f80c075c5daa8f534b477.NewAttachmentsRequestBuilder(m.currentPath + m.pathSegment, m.httpCore, false);
}
func (m *MessageRequestBuilder) AttachmentsById(id string)(iace81820e7196eb3ec506adf50a909fd751a256f8329891ef2cbbdd1d8fe9b2d.AttachmentRequestBuilder) {
    return *iace81820e7196eb3ec506adf50a909fd751a256f8329891ef2cbbdd1d8fe9b2d.NewAttachmentRequestBuilder(m.currentPath + m.pathSegment + "/attachments/" + id, m.httpCore, false);
}
...
func (m *MessageRequestBuilder) Content()(iaeab5810035e3d7ff3e4901893330c349ce3db065ba7b9e0dcaadaf7479be003.ContentRequestBuilder) {
    return *iaeab5810035e3d7ff3e4901893330c349ce3db065ba7b9e0dcaadaf7479be003.NewContentRequestBuilder(m.currentPath + m.pathSegment, m.httpCore, false);
}
...
func (m *MessageRequestBuilder) Extensions()(i1e8f5e1b0ab12ae689692569cf00409a7ffcf8119e0c731d1aab8fd8c24b9c9a.ExtensionsRequestBuilder) {
    return *i1e8f5e1b0ab12ae689692569cf00409a7ffcf8119e0c731d1aab8fd8c24b9c9a.NewExtensionsRequestBuilder(m.currentPath + m.pathSegment, m.httpCore, false);
}
func (m *MessageRequestBuilder) ExtensionsById(id string)(ibce1fc49ff1dfb26493978b2a56f0be047bae8336ff396cb9deb7e0715c92eca.ExtensionRequestBuilder) {
    return *ibce1fc49ff1dfb26493978b2a56f0be047bae8336ff396cb9deb7e0715c92eca.NewExtensionRequestBuilder(m.currentPath + m.pathSegment + "/extensions/" + id, m.httpCore, false);
}
...
func (m *MessageRequestBuilder) MultiValueExtendedProperties()(ic1605e2a56328ce22ef4db9ad89f54800a8f837cf7ba24dd304d6ddd4f629093.MultiValueExtendedPropertiesRequestBuilder) {
    return *ic1605e2a56328ce22ef4db9ad89f54800a8f837cf7ba24dd304d6ddd4f629093.NewMultiValueExtendedPropertiesRequestBuilder(m.currentPath + m.pathSegment, m.httpCore, false);
}
func (m *MessageRequestBuilder) MultiValueExtendedPropertiesById(id string)(i99bbed137b62cf613096d6395b85791513d9e404f617b07c9675049bc9df09f8.MultiValueLegacyExtendedPropertyRequestBuilder) {
    return *i99bbed137b62cf613096d6395b85791513d9e404f617b07c9675049bc9df09f8.NewMultiValueLegacyExtendedPropertyRequestBuilder(m.currentPath + m.pathSegment + "/multiValueExtendedProperties/" + id, m.httpCore, false);
}
...
func (m *MessageRequestBuilder) SingleValueExtendedProperties()(i5f4f3512bc76131a2bfb807e4ef99b24c83995d2d107aba0fd68cf3b07f8b750.SingleValueExtendedPropertiesRequestBuilder) {
    return *i5f4f3512bc76131a2bfb807e4ef99b24c83995d2d107aba0fd68cf3b07f8b750.NewSingleValueExtendedPropertiesRequestBuilder(m.currentPath + m.pathSegment, m.httpCore, false);
}
func (m *MessageRequestBuilder) SingleValueExtendedPropertiesById(id string)(idf8de8c43ef15f0fdc414d98d3e0cf730d22735ef1baafa82a410f3c5cbf2e90.SingleValueLegacyExtendedPropertyRequestBuilder) {
    return *idf8de8c43ef15f0fdc414d98d3e0cf730d22735ef1baafa82a410f3c5cbf2e90.NewSingleValueLegacyExtendedPropertyRequestBuilder(m.currentPath + m.pathSegment + "/singleValueExtendedProperties/" + id, m.httpCore, false);
}
