...
extension Swiftconsoleapp.Users.Item.MailFolders.Item.Messages.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        private var urlTemplate: String = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
