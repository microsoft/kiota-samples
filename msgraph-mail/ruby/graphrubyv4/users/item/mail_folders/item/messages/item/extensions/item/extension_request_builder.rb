...
module Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::Extensions::Item
    ...
    class ExtensionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter) 
            @url_template = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders/{mailFolder_id}/messages/{message_id}/extensions/{extension_id}{?select,expand}"
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::Extensions::Item::Extension, response_handler)
        end
        ## 
        ## The collection of open extensions defined for the message. Nullable.
        ## @param body 
