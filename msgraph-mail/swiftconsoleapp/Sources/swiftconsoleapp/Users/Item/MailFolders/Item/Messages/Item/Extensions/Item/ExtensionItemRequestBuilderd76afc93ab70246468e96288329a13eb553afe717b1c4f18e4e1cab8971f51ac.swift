...
extension Swiftconsoleapp.Users.Item.MailFolders.Item.Messages.Item.Extensions.Item {
    ...
    public class ExtensionItemRequestBuilder {
        ...
        private var urlTemplate: String = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/extensions/{extension%2Did}{?%24select,%24expand}"
