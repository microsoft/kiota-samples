...
module Graphrubyv4::Users::Item::Messages::Item::MultiValueExtendedProperties
    ...
    class MultiValueExtendedPropertiesRequestBuilder
        ...
        def get(request_configuration=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::Messages::Item::MultiValueExtendedProperties::MultiValueLegacyExtendedPropertyCollectionResponse, response_handler)
        end
        ## 
        ## Create new navigation property to multiValueExtendedProperties for users
        ## @param body 
