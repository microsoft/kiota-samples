...
namespace Graphdotnetv4.Users.MailFolders {
    ...
    public class MailFoldersRequestBuilder {
        ...
        /// <typeparam name="T">The generic type for the model, must inherit MailFoldersResponse</typeparam>
        /// </summary>
        public async Task<T> GetAsync<T>(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IResponseHandler responseHandler = default) where T : MailFoldersResponse, IParsable<T>, new(){
