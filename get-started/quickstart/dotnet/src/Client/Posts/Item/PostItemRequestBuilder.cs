...
namespace KiotaPosts.Client.Posts.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::KiotaPosts.Client.Posts.Item.PostItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::KiotaPosts.Client.Models.Post?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::KiotaPosts.Client.Models.Post> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::KiotaPosts.Client.Posts.Item.PostItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::KiotaPosts.Client.Posts.Item.PostItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
