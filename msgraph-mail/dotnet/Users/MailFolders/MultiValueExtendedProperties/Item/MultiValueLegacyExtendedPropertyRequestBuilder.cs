...
namespace Graphdotnetv4.Users.MailFolders.MultiValueExtendedProperties.Item {
    public class MultiValueLegacyExtendedPropertyRequestBuilder {
        ...
        public async Task<Entity> PatchAsync(MultiValueLegacyExtendedProperty body, Action<IDictionary<string, string>> h = default, IResponseHandler responseHandler = default) {
