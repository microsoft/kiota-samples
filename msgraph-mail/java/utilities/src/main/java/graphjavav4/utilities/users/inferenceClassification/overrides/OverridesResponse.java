...
public class OverridesResponse implements Parsable {
    ...
    private List<InferenceClassificationOverride> _value;
    /**
     ...
     */
    @javax.annotation.Nullable
    public List<InferenceClassificationOverride> getValue() {
        return this._value;
    }
    /**
     ...
     * @return a void
     */
    public void setValue(@javax.annotation.Nullable final List<InferenceClassificationOverride> value) {
        this._value = value;
    }
}
