...
public class UploadImageRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public UploadImageRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public UploadImageRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/pet/{petId}/uploadImage", rawUrl);
    }
    /**
     * uploads an image
    ...
    public ApiResponse post(@jakarta.annotation.Nonnull final InputStream body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, null, ApiResponse::createFromDiscriminatorValue);
    }
    /**
     * @param body Binary request body
