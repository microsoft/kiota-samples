...
namespace Graphdotnetv4.Users.MailFolders.ChildFolders {
    ...
    public class ChildFoldersRequestBuilder {
        ...
        /// <typeparam name="T">The generic type for the model, must inherit ChildFoldersResponse</typeparam>
        /// </summary>
        public async Task<T> GetAsync<T>(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IResponseHandler responseHandler = default) where T : ChildFoldersResponse, IParsable<T>, new(){
        ...
        /// <typeparam name="T">The generic type for the model, must inherit MailFolder</typeparam>
        /// </summary>
        public async Task<T> PostAsync<T>(T body, Action<IDictionary<string, string>> h = default, IResponseHandler responseHandler = default) where T : MailFolder, IParsable<T>, new(){
