...
module Graphrubyv4::Users::Item::MailFolders::Item::MessageRules::Item
    ...
    class MessageRuleRequestBuilder
        ...
        def initialize(path_parameters, request_adapter) 
            @url_template = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders/{mailFolder_id}/messageRules/{messageRule_id}{?select,expand}"
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::MailFolders::Item::MessageRules::Item::MessageRule, response_handler)
        end
        ## 
        ## The collection of rules that apply to the user's Inbox folder.
        ## @param body 
