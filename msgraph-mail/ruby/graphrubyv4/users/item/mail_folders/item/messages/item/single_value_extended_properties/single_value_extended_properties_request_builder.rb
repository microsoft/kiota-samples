...
module Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::SingleValueExtendedProperties
    ...
    class SingleValueExtendedPropertiesRequestBuilder
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesResponse, response_handler)
        end
        ## 
        ## The collection of single-value extended properties defined for the message. Nullable.
        ## @param body 
