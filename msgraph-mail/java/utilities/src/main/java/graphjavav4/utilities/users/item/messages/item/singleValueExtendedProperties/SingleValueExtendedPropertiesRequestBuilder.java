...
public class SingleValueExtendedPropertiesRequestBuilder {
     ...
     * @return a void
     */
    public SingleValueExtendedPropertiesRequestBuilder(final String currentPath, final RequestAdapter requestAdapter) {
     ...
     * @return a void
     */
    public SingleValueExtendedPropertiesRequestBuilder(@javax.annotation.Nonnull final String currentPath, @javax.annotation.Nonnull final RequestAdapter requestAdapter, final boolean isRawUrl) {
