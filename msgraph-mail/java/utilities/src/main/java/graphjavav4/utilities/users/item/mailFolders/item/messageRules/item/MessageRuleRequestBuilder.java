...
public class MessageRuleRequestBuilder {
     ...
     * @return a void
     */
    public MessageRuleRequestBuilder(@javax.annotation.Nonnull final HashMap<String, String> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
