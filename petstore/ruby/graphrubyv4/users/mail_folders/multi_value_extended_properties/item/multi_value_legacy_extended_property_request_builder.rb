...
module Graphrubyv4::Users::MailFolders::MultiValueExtendedProperties::Item
    ## 
    ...
    class MultiValueLegacyExtendedPropertyRequestBuilder
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::MailFolders::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedProperty, response_handler)
        end
        ## 
        ## Update the navigation property multiValueExtendedProperties in users
        ## @param body 
