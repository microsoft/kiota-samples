...
export class MailFoldersRequestBuilder {
    ...
    public get(q?: {
        ...
        return this.requestAdapter?.sendAsync<MailFoldersResponse>(requestInfo, MailFoldersResponse, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * The user's mail folders. Read-only. Nullable.
     * @param body 
