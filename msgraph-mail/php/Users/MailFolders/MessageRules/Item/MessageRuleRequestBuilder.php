...
namespace Microsoft\Graph\Users\MailFolders\MessageRules\Item;
...
class MessageRuleRequestBuilder 
{
    ...
    */
    public function get(GetQueryParameters $q, array $headers, array $options, ResponseHandlerInterface $responseHandler): ?MessageRule {
    }
     ...
     * @param ResponseHandlerInterface|null $responseHandler $responseHandler Response handler to use in place of the default response handling provided by the core service
    */
    public function patch(?MessageRule $body, array $headers, array $options, ResponseHandlerInterface $responseHandler): void {
    }
