...
public class AttachmentsResponse implements Parsable {
    ...
    private List<Attachment> _value;
    /**
    ...
    public <T> Map<String, BiConsumer<T, ParseNode>> getFieldDeserializers() {
        return new HashMap<>(2) {{
            ...
            this.put("value", (o, n) -> { ((AttachmentsResponse)o).setValue(n.getCollectionOfObjectValues(Attachment.class)); });
        }};
    }
    /**
     ...
     * @return a void
     */
    public void setValue(@javax.annotation.Nullable final List<Attachment> value) {
        this._value = value;
    }
}
