...
class MessageRulesResponse 
{
    ...
    /** @var MessageRule $value  */
    private MessageRule $value;
    ...
    */
    public function getValue(): ?MessageRule {
        return $this->value;
    }
    ...
    */
     ...
     *  @param MessageRule|null $value Value to set for the value property.
    */
    public function setValue(?MessageRule $value): void {
        $this->value = $value;
    }
