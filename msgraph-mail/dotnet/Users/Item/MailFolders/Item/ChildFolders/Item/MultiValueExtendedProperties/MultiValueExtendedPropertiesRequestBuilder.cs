...
using Graphdotnetv4.Users.Item.MailFolders.Item.ChildFolders.Item.MultiValueExtendedProperties.Item;
...
namespace Graphdotnetv4.Users.Item.MailFolders.Item.ChildFolders.Item.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\mailFolders\{mailFolder-id}\childFolders\{mailFolder-id1}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Graphdotnetv4.users.item.mailFolders.item.childFolders.item.multiValueExtendedProperties.item collection</summary>
