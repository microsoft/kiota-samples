...
public class MailFoldersRequestBuilder {
    ...
    /**
     * Get mailFolders from users
     * @param <U> The generic type for the model, must inherit MailFoldersResponse
     * @return a CompletableFuture of MailFoldersResponse
     */
    public <U extends MailFoldersResponse> java.util.concurrent.CompletableFuture<U> get() {
        try {
     ...
     * @return a CompletableFuture of MailFoldersResponse
     */
    public <U extends MailFoldersResponse> java.util.concurrent.CompletableFuture<U> get(@javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInfo requestInfo = createGetRequestInfo(
            );
     ...
     * @return a CompletableFuture of MailFoldersResponse
     */
    public <U extends MailFoldersResponse> java.util.concurrent.CompletableFuture<U> get(@javax.annotation.Nullable final java.util.function.Consumer<Map<String, String>> h, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInfo requestInfo = createGetRequestInfo(
                h
            );
