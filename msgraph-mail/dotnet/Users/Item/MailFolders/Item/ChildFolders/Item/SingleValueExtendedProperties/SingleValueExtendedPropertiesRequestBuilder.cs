...
using Graphdotnetv4.Users.Item.MailFolders.Item.ChildFolders.Item.SingleValueExtendedProperties.Item;
...
namespace Graphdotnetv4.Users.Item.MailFolders.Item.ChildFolders.Item.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\mailFolders\{mailFolder-id}\childFolders\{mailFolder-id1}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Graphdotnetv4.users.item.mailFolders.item.childFolders.item.singleValueExtendedProperties.item collection</summary>
