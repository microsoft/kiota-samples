...
namespace KiotaSamples.PetStoreSdk.User.CreateWithList {
    /// <summary>Builds and executes requests for operations under \user\createWithList</summary>
    public class CreateWithListRequestBuilder {
        ...
        /// </summary>
        public CreateWithListRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreatePostRequestInformation(List<KiotaSamples.PetStoreSdk.Models.User> body, Action<CreateWithListRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
            ...
            requestInfo.SetContentFromParsable(RequestAdapter, "application/json", body.ToArray());
        ...
        public async Task<Stream> PostAsync(List<KiotaSamples.PetStoreSdk.Models.User> body, Action<CreateWithListRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
