...
public class OverridesRequestBuilder {
     ...
     * @return a void
     */
    public OverridesRequestBuilder(final String currentPath, final RequestAdapter requestAdapter) {
     ...
     * @return a void
     */
    public OverridesRequestBuilder(@javax.annotation.Nonnull final String currentPath, @javax.annotation.Nonnull final RequestAdapter requestAdapter, final boolean isRawUrl) {
    ...
    public java.util.concurrent.CompletableFuture<OverridesResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, OverridesResponse.class, null);
