...
module Graphrubyv4::Users::Item::Messages::Item::SingleValueExtendedProperties
    ...
    class SingleValueExtendedPropertiesRequestBuilder
        ...
        def get(request_configuration=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::Messages::Item::SingleValueExtendedProperties::SingleValueLegacyExtendedPropertyCollectionResponse, response_handler)
        end
        ## 
        ## Create new navigation property to singleValueExtendedProperties for users
        ## @param body 
