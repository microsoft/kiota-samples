...
module Graphrubyv4::Users::Messages::Extensions::Item
    ## 
    ...
    class ExtensionRequestBuilder
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Messages::Extensions::Item::Extension, response_handler)
        end
        ## 
        ## Update the navigation property extensions in users
        ## @param body 
