...
require_relative './item/attachment_request_builder'

module Graphrubyv4::Utilities::Users::MailFolders::Messages::Attachments
    ## 
    ...
    class AttachmentsRequestBuilder
        ...
        @path_segment
        ## 
        # Gets an item from the graphrubyv4.utilities.users.mailFolders.messages.attachments collection
        def [](position)
            return AttachmentRequestBuilder.new(@current_path + @path_segment  + "/" + position, @http_core)
        end
        ## 
