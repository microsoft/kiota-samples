...
class ChildFoldersRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/mailFolders/{mailFolder_id}/childFolders{?top,skip,search,filter,count,orderby,select,expand}';
    ...
    */
     ...
     * @return Promise
    */
    public function post(MailFolder $body, ?array $headers, ?array $options, ?ResponseHandler $responseHandler): Promise {
