...
replace github.com/microsoft/kiota-samples/msgraph-mail/go/utilities/users/mailFolders/singleValueExtendedProperties/item => ./item
...
require (
    github.com/microsoft/kiota-samples/msgraph-mail/go/utilities/users/mailFolders/singleValueExtendedProperties/item v0.0.0-00010101000000-000000000000
