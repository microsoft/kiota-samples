...
// DeleteWithRequestConfigurationAndResponseHandler the collection of single-value extended properties defined for the mailFolder. Read-only. Nullable.
...
// PatchWithRequestConfigurationAndResponseHandler the collection of single-value extended properties defined for the mailFolder. Read-only. Nullable.
