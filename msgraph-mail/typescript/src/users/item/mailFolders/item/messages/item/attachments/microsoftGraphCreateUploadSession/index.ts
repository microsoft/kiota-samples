 ...
 */
export const MicrosoftGraphCreateUploadSessionRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/attachments/microsoft.graph.createUploadSession";
/**
