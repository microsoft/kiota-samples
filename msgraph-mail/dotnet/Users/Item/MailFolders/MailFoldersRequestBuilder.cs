...
namespace Graphdotnetv4.Users.Item.MailFolders {
    ...
    public class MailFoldersRequestBuilder {
        ...
        public MailFoldersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders{?top,skip,search,filter,count,orderby,select,expand}";
        ...
        /// </summary>
        public MailFoldersRequestBuilder(Dictionary<string, string> urlTemplateParameters, IRequestAdapter requestAdapter) {
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
