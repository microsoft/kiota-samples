...
extension Swiftconsoleapp.Users.Item.MailFolders.Item.Messages.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        private var urlTemplate: String = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
