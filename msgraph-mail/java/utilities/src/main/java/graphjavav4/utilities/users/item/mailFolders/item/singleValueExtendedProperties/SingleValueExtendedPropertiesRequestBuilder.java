...
public class SingleValueExtendedPropertiesRequestBuilder {
     ...
     * @return a void
     */
    public SingleValueExtendedPropertiesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, String> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
