...
module Graphrubyv4::Users::Item::MailFolders::Item::ChildFolders
    ...
    class ChildFoldersRequestBuilder
        ...
        def initialize(path_parameters, request_adapter) 
            @url_template = "{+baseurl}/users/{user_id}/mailFolders/{mailFolder_id}/childFolders{?top,skip,filter,count,orderby,select,expand}"
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::MailFolders::Item::ChildFolders::ChildFoldersResponse, response_handler)
        end
        ## 
        ## The collection of child folders in the mailFolder.
        ## @param body 
        ...
        def post(body, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::MailFolders::Item::ChildFolders::MailFolder, response_handler)
        end
    end
end
