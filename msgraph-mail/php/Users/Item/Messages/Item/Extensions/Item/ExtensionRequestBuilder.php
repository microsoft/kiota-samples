...
class ExtensionRequestBuilder 
{
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(Extension $body, ?array $, ?array $options): RequestInformation {
    }
    ...
    */
    public function get(?GetQueryParameters $q, ?array $, ?array $options, ?IResponseHandler $$responseHandler): ?Extension {
    }
     ...
     * @param IResponseHandler|null $$responseHandler $responseHandler Response handler to use in place of the default response handling provided by the core service
    */
    public function patch(Extension $body, ?array $, ?array $options, ?IResponseHandler $$responseHandler): void {
    }
