...
extension Swiftconsoleapp.Users.Item.MailFolders.Item.MultiValueExtendedProperties.Item {
    ...
    public class MultiValueLegacyExtendedPropertyItemRequestBuilder {
        ...
        private var urlTemplate: String = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty%2Did}{?%24select,%24expand}"
