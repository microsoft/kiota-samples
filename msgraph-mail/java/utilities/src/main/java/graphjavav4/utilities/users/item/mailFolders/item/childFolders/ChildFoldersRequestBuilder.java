...
public class ChildFoldersRequestBuilder {
     ...
     * @return a void
     */
    public ChildFoldersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, String> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
