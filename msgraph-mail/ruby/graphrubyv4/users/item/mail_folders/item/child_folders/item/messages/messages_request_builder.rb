...
module Graphrubyv4::Users::Item::MailFolders::Item::ChildFolders::Item::Messages
    ...
    class MessagesRequestBuilder
        ...
        def get(request_configuration=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::MessageCollectionResponse, response_handler)
        end
        ## 
        ## Create new navigation property to messages for users
        ## @param body 
        ...
        def post(body, request_configuration=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Message, response_handler)
        end
