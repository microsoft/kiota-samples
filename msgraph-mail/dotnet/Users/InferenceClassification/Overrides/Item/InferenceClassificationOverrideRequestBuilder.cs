...
namespace Graphdotnetv4.Users.InferenceClassification.Overrides.Item {
    public class InferenceClassificationOverrideRequestBuilder {
        ...
        public async Task<Entity> PatchAsync(InferenceClassificationOverride body, Action<IDictionary<string, string>> h = default, IResponseHandler responseHandler = default) {
