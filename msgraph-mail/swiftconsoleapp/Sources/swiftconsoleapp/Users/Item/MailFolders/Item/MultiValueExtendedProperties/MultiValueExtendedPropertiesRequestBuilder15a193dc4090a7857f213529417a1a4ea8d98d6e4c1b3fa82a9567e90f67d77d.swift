...
extension Swiftconsoleapp.Users.Item.MailFolders.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        private var urlTemplate: String = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
