...
namespace Graphdotnetv4.Users.MailFolders.Messages.Attachments.Item {
    ...
    public class AttachmentRequestBuilder {
        ...
        /// </summary>
        public AttachmentRequestBuilder(string currentPath, IHttpCore httpCore) {
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInfo CreatePatchRequestInfo(Attachment body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
