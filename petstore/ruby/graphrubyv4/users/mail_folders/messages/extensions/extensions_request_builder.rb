...
module Graphrubyv4::Users::MailFolders::Messages::Extensions
    ...
    class ExtensionsRequestBuilder
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::MailFolders::Messages::Extensions::ExtensionsResponse, response_handler)
        end
        ## 
        ## Create new navigation property to extensions for users
        ## @param body 
        ...
        def post(body, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::MailFolders::Messages::Extensions::Extension, response_handler)
        end
    end
end
