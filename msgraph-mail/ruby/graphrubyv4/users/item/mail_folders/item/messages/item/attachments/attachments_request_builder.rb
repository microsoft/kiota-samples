...
module Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::Attachments
    ## 
    ...
    class AttachmentsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter) 
            @url_template = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders/{mailFolder_id}/messages/{message_id}/attachments{?top,skip,search,filter,count,orderby,select,expand}"
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::Attachments::AttachmentsResponse, response_handler)
        end
        ## 
        ## The fileAttachment and itemAttachment attachments for the message.
        ## @param body 
        ...
        def post(body, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::Attachments::Attachment, response_handler)
        end
    end
end
