...
namespace Microsoft\Graph\Users\MailFolders\Messages\Extensions\Item;
...
class ExtensionRequestBuilder 
{
    ...
    */
    public function get(GetQueryParameters $q, array $headers, array $options, ResponseHandlerInterface $responseHandler): ?Extension {
    }
     ...
     * @param ResponseHandlerInterface|null $responseHandler $responseHandler Response handler to use in place of the default response handling provided by the core service
    */
    public function patch(?Extension $body, array $headers, array $options, ResponseHandlerInterface $responseHandler): void {
    }
