...
class MessageRuleRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/mailFolders/{mailFolder_id}/messageRules/{messageRule_id}{?select,expand}';
    ...
    */
     ...
     * @return Promise
    */
    public function patch(MessageRule $body, ?array $headers, ?array $options, ?ResponseHandler $responseHandler): Promise {
