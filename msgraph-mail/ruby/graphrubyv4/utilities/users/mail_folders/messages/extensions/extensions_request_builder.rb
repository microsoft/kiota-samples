...
module Graphrubyv4::Utilities::Users::MailFolders::Messages::Extensions
    ## 
    ...
    class ExtensionsRequestBuilder
        ...
        @path_segment
        ## 
        # Gets an item from the graphrubyv4.utilities.users.mailFolders.messages.extensions collection
        def [](position)
