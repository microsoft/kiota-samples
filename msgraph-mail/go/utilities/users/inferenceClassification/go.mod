...
replace github.com/microsoft/kiota-samples/msgraph-mail/go/utilities/users/inferenceClassification/overrides => ./overrides
...
require (
    github.com/microsoft/kiota-samples/msgraph-mail/go/utilities/users/inferenceClassification/overrides v0.0.0-00010101000000-000000000000
