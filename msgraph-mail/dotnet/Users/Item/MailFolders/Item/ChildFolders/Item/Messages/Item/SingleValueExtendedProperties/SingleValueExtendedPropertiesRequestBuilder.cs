...
using Graphdotnetv4.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.SingleValueExtendedProperties.Item;
...
namespace Graphdotnetv4.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\mailFolders\{mailFolder-id}\childFolders\{mailFolder-id1}\messages\{message-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Graphdotnetv4.users.item.mailFolders.item.childFolders.item.messages.item.singleValueExtendedProperties.item collection</summary>
        ...
        public async Task<SingleValueLegacyExtendedPropertyCollectionResponse> GetAsync(Action<SingleValueExtendedPropertiesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<SingleValueLegacyExtendedPropertyCollectionResponse>(requestInfo, SingleValueLegacyExtendedPropertyCollectionResponse.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to singleValueExtendedProperties for users
        /// </summary>
