    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return array_merge(parent::getFieldDeserializers(), [
            'attachments' => fn(ParseNode $n) => $o->setAttachments($n->getCollectionOfObjectValues(array(Attachment::class, 'createFromDiscriminatorValue'))),
            'bccRecipients' => fn(ParseNode $n) => $o->setBccRecipients($n->getCollectionOfObjectValues(array(Recipient::class, 'createFromDiscriminatorValue'))),
            'body' => fn(ParseNode $n) => $o->setBody($n->getObjectValue(array(ItemBody::class, 'createFromDiscriminatorValue'))),
            'bodyPreview' => fn(ParseNode $n) => $o->setBodyPreview($n->getStringValue()),
            'ccRecipients' => fn(ParseNode $n) => $o->setCcRecipients($n->getCollectionOfObjectValues(array(Recipient::class, 'createFromDiscriminatorValue'))),
            ...
            'extensions' => fn(ParseNode $n) => $o->setExtensions($n->getCollectionOfObjectValues(array(Extension::class, 'createFromDiscriminatorValue'))),
            'flag' => fn(ParseNode $n) => $o->setFlag($n->getObjectValue(array(FollowupFlag::class, 'createFromDiscriminatorValue'))),
            'from' => fn(ParseNode $n) => $o->setFrom($n->getObjectValue(array(Recipient::class, 'createFromDiscriminatorValue'))),
            ...
            'internetMessageHeaders' => fn(ParseNode $n) => $o->setInternetMessageHeaders($n->getCollectionOfObjectValues(array(InternetMessageHeader::class, 'createFromDiscriminatorValue'))),
            ...
            'replyTo' => fn(ParseNode $n) => $o->setReplyTo($n->getCollectionOfObjectValues(array(Recipient::class, 'createFromDiscriminatorValue'))),
            'sender' => fn(ParseNode $n) => $o->setSender($n->getObjectValue(array(Recipient::class, 'createFromDiscriminatorValue'))),
            ...
            'toRecipients' => fn(ParseNode $n) => $o->setToRecipients($n->getCollectionOfObjectValues(array(Recipient::class, 'createFromDiscriminatorValue'))),
            'uniqueBody' => fn(ParseNode $n) => $o->setUniqueBody($n->getObjectValue(array(ItemBody::class, 'createFromDiscriminatorValue'))),
