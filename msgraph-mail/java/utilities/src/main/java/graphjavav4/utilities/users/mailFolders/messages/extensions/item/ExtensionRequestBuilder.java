...
public class ExtensionRequestBuilder {
    ...
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Entity> patch(@javax.annotation.Nonnull final Extension body, @javax.annotation.Nullable final java.util.function.Consumer<Map<String, String>> h, @javax.annotation.Nullable final ResponseHandler responseHandler) {
    ...
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Entity> patch(@javax.annotation.Nonnull final Extension body, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInfo requestInfo = createPatchRequestInfo(
                body
    ...
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Entity> patch(@javax.annotation.Nonnull final Extension body) {
        Objects.requireNonNull(body);
        try {
            final RequestInfo requestInfo = createPatchRequestInfo(
                body
