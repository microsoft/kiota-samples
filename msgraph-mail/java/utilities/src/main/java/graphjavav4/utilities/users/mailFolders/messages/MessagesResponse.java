...
public class MessagesResponse implements Parsable {
    ...
    public <T> Map<String, BiConsumer<T, ParseNode>> getFieldDeserializers() {
        return new HashMap<>(2) {{
            ...
            this.put("value", (o, n) -> { ((MessagesResponse)o).setValue(n.getCollectionOfObjectValues(Message.class)); });
        }};
    }
    /**
     ...
     * @return a void
     */
    public void setValue(@javax.annotation.Nullable final List<Message> value) {
        this._value = value;
    }
}
