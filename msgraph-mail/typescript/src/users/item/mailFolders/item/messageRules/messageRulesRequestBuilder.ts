...
export class MessageRulesRequestBuilder {
    ...
    public get(q?: {
        ...
        return this.requestAdapter?.sendAsync<MessageRulesResponse>(requestInfo, MessageRulesResponse, responseHandler, errorMapping) ?? Promise.reject(new Error('http core is null'));
    };
    /**
     * The collection of rules that apply to the user's Inbox folder.
     * @param body 
