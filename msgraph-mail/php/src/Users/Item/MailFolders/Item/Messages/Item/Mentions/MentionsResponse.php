...
class MentionsResponse implements Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        return  [
            '@odata.nextLink' => function (MentionsResponse $o, string $n) { $o->setNextLink($n); },
            'value' => function (MentionsResponse $o, array $n) { $o->setValue($n); },
        ];
    }
