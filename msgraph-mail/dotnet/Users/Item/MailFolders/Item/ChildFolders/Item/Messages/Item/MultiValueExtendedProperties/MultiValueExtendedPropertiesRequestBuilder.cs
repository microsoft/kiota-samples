...
using Graphdotnetv4.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MultiValueExtendedProperties.Item;
...
namespace Graphdotnetv4.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\mailFolders\{mailFolder-id}\childFolders\{mailFolder-id1}\messages\{message-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Graphdotnetv4.users.item.mailFolders.item.childFolders.item.messages.item.multiValueExtendedProperties.item collection</summary>
        ...
        public async Task<MultiValueLegacyExtendedPropertyCollectionResponse> GetAsync(Action<MultiValueExtendedPropertiesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<MultiValueLegacyExtendedPropertyCollectionResponse>(requestInfo, MultiValueLegacyExtendedPropertyCollectionResponse.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to multiValueExtendedProperties for users
        /// </summary>
