...
module Graphrubyv4::Users::MailFolders::Messages::SingleValueExtendedProperties
    ...
    class SingleValueExtendedPropertiesRequestBuilder
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::MailFolders::Messages::SingleValueExtendedProperties::SingleValueExtendedPropertiesResponse, response_handler)
        end
        ## 
        ## Create new navigation property to singleValueExtendedProperties for users
        ## @param body 
        ...
        def post(body, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::MailFolders::Messages::SingleValueExtendedProperties::SingleValueLegacyExtendedProperty, response_handler)
        end
    end
end
