...
module Graphrubyv4::Utilities::Users::MailFolders::MultiValueExtendedProperties
    ## 
    ...
    class MultiValueExtendedPropertiesRequestBuilder
        ...
        @path_segment
        ## 
        # Gets an item from the graphrubyv4.utilities.users.mailFolders.multiValueExtendedProperties collection
        def [](position)
