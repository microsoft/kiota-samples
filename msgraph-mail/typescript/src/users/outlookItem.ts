...
export class OutlookItem extends Entity implements Parsable<OutlookItem> {
     ...
     */
    public getFieldDeserializers () : Map<string, (item: OutlookItem, node: ParseNode) => void> {
        return new Map<string, (item: OutlookItem, node: ParseNode) => void>([...super.getFieldDeserializers(),
