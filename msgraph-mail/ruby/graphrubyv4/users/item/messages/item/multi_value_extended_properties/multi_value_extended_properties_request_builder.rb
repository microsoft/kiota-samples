...
module Graphrubyv4::Users::Item::Messages::Item::MultiValueExtendedProperties
    ...
    class MultiValueExtendedPropertiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter) 
            @url_template = "https://graph.microsoft.com/v1.0/users/{user_id}/messages/{message_id}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}"
