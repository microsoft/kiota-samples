...
namespace Graphdotnetv4.Users.InferenceClassification.Overrides.Item {
    ...
    public class InferenceClassificationOverrideRequestBuilder {
        ...
        /// <typeparam name="T">The generic type for the model, must inherit InferenceClassificationOverride</typeparam>
        /// </summary>
        public async Task<T> GetAsync<T>(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IResponseHandler responseHandler = default) where T : InferenceClassificationOverride, IParsable<T>, new(){
        ...
        /// <typeparam name="T">The generic type for the model, must inherit InferenceClassificationOverride</typeparam>
        /// </summary>
        public async Task PatchAsync<T>(T body, Action<IDictionary<string, string>> h = default, IResponseHandler responseHandler = default) where T : InferenceClassificationOverride, IParsable<T>, new(){
