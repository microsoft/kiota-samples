...
module GraphC::Models
    class InferenceClassification < GraphC::Models::Entity
        ...
        def get_field_deserializers() 
            return super.merge({
                "overrides" => lambda {|o, n| o.overrides = n.get_collection_of_object_values(GraphC::Models::InferenceClassificationOverride) },
            })
        end
        ## 
