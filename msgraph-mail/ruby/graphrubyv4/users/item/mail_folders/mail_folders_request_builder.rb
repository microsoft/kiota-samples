...
module Graphrubyv4::Users::Item::MailFolders
    ...
    class MailFoldersRequestBuilder
        ...
        def initialize(path_parameters, request_adapter) 
            @url_template = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders{?top,skip,search,filter,count,orderby,select,expand}"
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::MailFolders::MailFoldersResponse, response_handler)
        end
        ## 
        ## The user's mail folders. Read-only. Nullable.
        ## @param body 
