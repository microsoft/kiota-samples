...
namespace KiotaSamples.PetStoreSdk.User.CreateWithArray {
    /// <summary>Builds and executes requests for operations under \user\createWithArray</summary>
    public class CreateWithArrayRequestBuilder {
        ...
        public RequestInformation CreatePostRequestInformation(List<KiotaSamples.PetStoreSdk.Models.User> body, Action<CreateWithArrayRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        public async Task<Stream> PostAsync(List<KiotaSamples.PetStoreSdk.Models.User> body, Action<CreateWithArrayRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
