...
namespace Graphdotnetv4.Users.Item.InferenceClassification.Overrides.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Graphdotnetv4.Users.Item.InferenceClassification.Overrides.Item.InferenceClassificationOverrideItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Graphdotnetv4.Models.InferenceClassificationOverride?> PatchAsync(Graphdotnetv4.Models.InferenceClassificationOverride body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Graphdotnetv4.Models.InferenceClassificationOverride> PatchAsync(Graphdotnetv4.Models.InferenceClassificationOverride body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Graphdotnetv4.Users.Item.InferenceClassification.Overrides.Item.InferenceClassificationOverrideItemRequestBuilder.InferenceClassificationOverrideItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Graphdotnetv4.Users.Item.InferenceClassification.Overrides.Item.InferenceClassificationOverrideItemRequestBuilder.InferenceClassificationOverrideItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Graphdotnetv4.Models.InferenceClassificationOverride body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Graphdotnetv4.Models.InferenceClassificationOverride body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Graphdotnetv4.Users.Item.InferenceClassification.Overrides.Item.InferenceClassificationOverrideItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Graphdotnetv4.Users.Item.InferenceClassification.Overrides.Item.InferenceClassificationOverrideItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class InferenceClassificationOverrideItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Graphdotnetv4.Users.Item.InferenceClassification.Overrides.Item.InferenceClassificationOverrideItemRequestBuilder.InferenceClassificationOverrideItemRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
