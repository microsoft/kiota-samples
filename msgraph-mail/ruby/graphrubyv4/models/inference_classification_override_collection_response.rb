        ...
        class InferenceClassificationOverrideCollectionResponse
            ...
            def get_field_deserializers()
                return {
                    ...
                    "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| Graphrubyv4::Models::InferenceClassificationOverride.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
