...
class ExtensionsRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/mailFolders/{mailFolder_id}/messages/{message_id}/extensions{?top,skip,search,filter,count,orderby,select,expand}';
    ...
    */
     ...
     * @return Promise
    */
    public function post(Extension $body, ?array $headers, ?array $options, ?ResponseHandler $responseHandler): Promise {
