...
namespace Graphdotnetv4.Users.Messages.SingleValueExtendedProperties.Item {
    public class SingleValueLegacyExtendedPropertyRequestBuilder {
        ...
        public async Task<Entity> PatchAsync(SingleValueLegacyExtendedProperty body, Action<IDictionary<string, string>> h = default, IResponseHandler responseHandler = default) {
