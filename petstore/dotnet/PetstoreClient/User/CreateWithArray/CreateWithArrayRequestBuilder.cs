...
namespace KiotaSamples.PetStoreSdk.User.CreateWithArray {
    ...
    public class CreateWithArrayRequestBuilder {
        ...
        public CreateWithArrayRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<Stream?> PostAsync(List<KiotaSamples.PetStoreSdk.Models.User> body, Action<CreateWithArrayRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(List<KiotaSamples.PetStoreSdk.Models.User> body, Action<CreateWithArrayRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(List<KiotaSamples.PetStoreSdk.Models.User> body, Action<CreateWithArrayRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(List<KiotaSamples.PetStoreSdk.Models.User> body, Action<CreateWithArrayRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
