...
namespace Graphdotnetv4.Users.Item.MailFolders.Item.Messages.Item.Attachments.Item {
    ...
    public class AttachmentRequestBuilder {
        ...
        /// </summary>
        public AttachmentRequestBuilder(Dictionary<string, string> urlTemplateParameters, IRequestAdapter requestAdapter) {
