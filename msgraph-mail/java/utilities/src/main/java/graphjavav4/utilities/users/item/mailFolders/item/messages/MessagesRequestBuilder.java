...
public class MessagesRequestBuilder {
     ...
     * @return a void
     */
    public MessagesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, String> urlTemplateParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
