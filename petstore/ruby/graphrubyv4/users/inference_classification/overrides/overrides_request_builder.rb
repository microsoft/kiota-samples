...
module Graphrubyv4::Users::InferenceClassification::Overrides
    ...
    class OverridesRequestBuilder
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::InferenceClassification::Overrides::OverridesResponse, response_handler)
        end
        ## 
        ## Create new navigation property to overrides for users
        ## @param body 
        ...
        def post(body, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::InferenceClassification::Overrides::InferenceClassificationOverride, response_handler)
        end
    end
end
