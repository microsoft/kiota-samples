...
public class MailFoldersRequestBuilder {
     ...
     * @return a void
     */
    public MailFoldersRequestBuilder(@javax.annotation.Nonnull final String rawUrl, final RequestAdapter requestAdapter) {
        this.urlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders{?top,skip,search,filter,count,orderby,select,expand}";
     ...
     * @return a void
     */
    public MailFoldersRequestBuilder(@javax.annotation.Nonnull final HashMap<String, String> urlTemplateParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<MailFoldersResponse> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, MailFoldersResponse.class, null);
