...
module Graphrubyv4::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::Extensions::Item
    ## 
    ...
    class ExtensionItemRequestBuilder
        ...
        def get(request_configuration=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::Extensions::Item::Extension, response_handler)
        end
        ## 
        ## Update the navigation property extensions in users
        ## @param body 
