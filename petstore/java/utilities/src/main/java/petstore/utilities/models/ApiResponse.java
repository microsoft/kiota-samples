...
public class ApiResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ApiResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
