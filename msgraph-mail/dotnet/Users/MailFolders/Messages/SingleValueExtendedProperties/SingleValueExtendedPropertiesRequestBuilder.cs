...
namespace Graphdotnetv4.Users.MailFolders.Messages.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Graphdotnetv4.users.mailFolders.messages.singleValueExtendedProperties collection</summary>
        ...
        /// <param name="h">Request headers</param>
        /// <typeparam name="T">The generic type for the model, must inherit SingleValueLegacyExtendedProperty</typeparam>
        /// </summary>
        ...
        /// <typeparam name="T">The generic type for the model, must inherit SingleValueExtendedPropertiesResponse</typeparam>
        /// </summary>
