...
namespace Microsoft\Graph\Users\InferenceClassification\Overrides\Item;
...
class InferenceClassificationOverrideRequestBuilder 
{
    ...
    */
    public function get(GetQueryParameters $q, array $headers, array $options, ResponseHandlerInterface $responseHandler): ?InferenceClassificationOverride {
    }
     ...
     * @param ResponseHandlerInterface|null $responseHandler $responseHandler Response handler to use in place of the default response handling provided by the core service
    */
    public function patch(?InferenceClassificationOverride $body, array $headers, array $options, ResponseHandlerInterface $responseHandler): void {
    }
