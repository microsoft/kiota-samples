...
module Graphrubyv4::Users::Messages::Attachments::Item
    ## 
    ...
    class AttachmentRequestBuilder
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Messages::Attachments::Item::Attachment, response_handler)
        end
        ## 
        ## Update the navigation property attachments in users
        ## @param body 
