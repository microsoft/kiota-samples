...
#nullable enable
        public async Task<Stream?> PostAsync(List<KiotaSamples.PetStoreSdk.Models.User> body, Action<CreateWithListRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(List<KiotaSamples.PetStoreSdk.Models.User> body, Action<CreateWithListRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(List<KiotaSamples.PetStoreSdk.Models.User> body, Action<CreateWithListRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(List<KiotaSamples.PetStoreSdk.Models.User> body, Action<CreateWithListRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
