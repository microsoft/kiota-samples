...
public class MessageRuleRequestBuilder {
     ...
     * @return a void
     */
    public MessageRuleRequestBuilder(final String currentPath, final RequestAdapter requestAdapter) {
     ...
     * @return a void
     */
    public MessageRuleRequestBuilder(@javax.annotation.Nonnull final String currentPath, @javax.annotation.Nonnull final RequestAdapter requestAdapter, final boolean isRawUrl) {
