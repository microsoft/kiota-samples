...
module Graphrubyv4::Users::Item::MailFolders::Item::Messages
    ...
    class MessagesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter) 
            @url_template = "https://graph.microsoft.com/v1.0/users/{user_id}/mailFolders/{mailFolder_id}/messages{?top,skip,search,filter,count,orderby,select,expand}"
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Item::MailFolders::Item::Messages::MessagesResponse, response_handler)
        end
        ## 
        ## The collection of messages in the mailFolder.
        ## @param body 
