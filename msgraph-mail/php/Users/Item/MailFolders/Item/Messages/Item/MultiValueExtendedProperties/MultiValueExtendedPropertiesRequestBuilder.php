...
class MultiValueExtendedPropertiesRequestBuilder 
{
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPostRequestInformation(MultiValueLegacyExtendedProperty $body, ?array $, ?array $options): RequestInformation {
    }
    ...
    */
    public function get(?GetQueryParameters $q, ?array $, ?array $options, ?IResponseHandler $$responseHandler): ?MultiValueExtendedPropertiesResponse {
    }
    ...
    */
    public function post(MultiValueLegacyExtendedProperty $body, ?array $, ?array $options, ?IResponseHandler $$responseHandler): ?MultiValueLegacyExtendedProperty {
    }
