package graphjavav4.utilities.users.mailFolders.messages.singleValueExtendedProperties.item;
...
public class SingleValueLegacyExtendedPropertyRequestBuilder {
     ...
     */
    @javax.annotation.Nonnull
    public <U extends SingleValueLegacyExtendedProperty> RequestInfo createPatchRequestInfo(@javax.annotation.Nonnull final U body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public <U extends SingleValueLegacyExtendedProperty> RequestInfo createPatchRequestInfo(@javax.annotation.Nonnull final U body, @javax.annotation.Nullable final java.util.function.Consumer<Map<String, String>> h) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInfo requestInfo = new RequestInfo() {{
            uri = new URI(currentPath + pathSegment);
            httpMethod = HttpMethod.PATCH;
     ...
     */
    public <U extends SingleValueLegacyExtendedProperty> java.util.concurrent.CompletableFuture<U> get() {
        try {
     ...
     * @return a CompletableFuture of SingleValueLegacyExtendedProperty
     */
    public <U extends SingleValueLegacyExtendedProperty> java.util.concurrent.CompletableFuture<U> get(@javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInfo requestInfo = createGetRequestInfo(
            );
     ...
     * @return a CompletableFuture of SingleValueLegacyExtendedProperty
     */
    public <U extends SingleValueLegacyExtendedProperty> java.util.concurrent.CompletableFuture<U> get(@javax.annotation.Nullable final java.util.function.Consumer<Map<String, String>> h, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        try {
            final RequestInfo requestInfo = createGetRequestInfo(
                h
            );
     ...
     * @return a CompletableFuture of void
     */
    public <U extends SingleValueLegacyExtendedProperty> java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final U body) {
        Objects.requireNonNull(body);
        try {
     ...
     * @return a CompletableFuture of void
     */
    public <U extends SingleValueLegacyExtendedProperty> java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final U body, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInfo requestInfo = createPatchRequestInfo(
                body
     ...
     * @return a CompletableFuture of void
     */
    public <U extends SingleValueLegacyExtendedProperty> java.util.concurrent.CompletableFuture<Void> patch(@javax.annotation.Nonnull final U body, @javax.annotation.Nullable final java.util.function.Consumer<Map<String, String>> h, @javax.annotation.Nullable final ResponseHandler responseHandler) {
        Objects.requireNonNull(body);
        try {
            final RequestInfo requestInfo = createPatchRequestInfo(
                body, h
