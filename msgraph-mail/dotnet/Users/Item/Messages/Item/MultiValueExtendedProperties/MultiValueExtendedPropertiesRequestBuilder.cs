...
using Graphdotnetv4.Users.Item.Messages.Item.MultiValueExtendedProperties.Item;
...
namespace Graphdotnetv4.Users.Item.Messages.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Graphdotnetv4.users.item.messages.item.multiValueExtendedProperties.item collection</summary>
        ...
        /// </summary>
        public async Task<MultiValueExtendedPropertiesResponse> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
