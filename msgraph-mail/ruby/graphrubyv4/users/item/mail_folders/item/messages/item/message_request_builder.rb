...
module Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item
    ...
    class MessageRequestBuilder
        ...
        def attachments()
            return Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::Attachments::AttachmentsRequestBuilder.new(@current_path + @path_segment , @request_adapter, false)
        end
        def content()
            return Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::Value::ContentRequestBuilder.new(@current_path + @path_segment , @request_adapter, false)
        end
        ## 
        # Current path for the request
        @current_path
        def extensions()
            return Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::Extensions::ExtensionsRequestBuilder.new(@current_path + @path_segment , @request_adapter, false)
        end
        ## 
        # Whether the current path is a raw URL
        @is_raw_url
        def multi_value_extended_properties()
            return Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@current_path + @path_segment , @request_adapter, false)
        end
        ## 
        ...
        def single_value_extended_properties()
            return Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@current_path + @path_segment , @request_adapter, false)
        end
        ## 
        ...
        def attachments_by_id(id) 
            return Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::Attachments::Item::AttachmentRequestBuilder.new(@current_path + @path_segment  + "/attachments/" + id, @request_adapter, false)
        end
        ## 
        ...
        def extensions_by_id(id) 
            return Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::Extensions::Item::ExtensionRequestBuilder.new(@current_path + @path_segment  + "/extensions/" + id, @request_adapter, false)
        end
        ## 
        ## The collection of messages in the mailFolder.
        ## @param h Request headers
        ...
        def multi_value_extended_properties_by_id(id) 
            return Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyRequestBuilder.new(@current_path + @path_segment  + "/multiValueExtendedProperties/" + id, @request_adapter, false)
        end
        ## 
        ## The collection of messages in the mailFolder.
        ## @param body 
        ...
        def single_value_extended_properties_by_id(id) 
            return Graphrubyv4::Users::Item::MailFolders::Item::Messages::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyRequestBuilder.new(@current_path + @path_segment  + "/singleValueExtendedProperties/" + id, @request_adapter, false)
        end
    end
end
