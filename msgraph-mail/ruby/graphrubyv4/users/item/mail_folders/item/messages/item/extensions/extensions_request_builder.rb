...
module GraphC::Users::Item::MailFolders::Item::Messages::Item::Extensions
    ...
    class ExtensionsRequestBuilder
        ...
        def get(request_configuration=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, GraphC::Users::Item::MailFolders::Item::Messages::Item::Extensions::ExtensionCollectionResponse, response_handler)
        end
        ## 
        ## Create new navigation property to extensions for users
        ## @param body 
        ...
        def post(body, request_configuration=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, GraphC::Users::Item::MailFolders::Item::Messages::Item::Extensions::Extension, response_handler)
        end
        require '../../../../../../users'
        require '../../../../../item'
        require '../../../../mail_folders'
