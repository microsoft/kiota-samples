...
namespace Graphdotnetv4.Users.MailFolders.ChildFolders {
    ...
    public class ChildFoldersRequestBuilder {
        ...
        public MailFolderRequestBuilder this[string position] { get {
            return new MailFolderRequestBuilder(CurrentPath + PathSegment  + "/" + position, HttpCore);
        } }
        /// <summary>
        ...
        /// </summary>
        public ChildFoldersRequestBuilder(string currentPath, IHttpCore httpCore) {
        ...
        /// <param name="o">Request options for HTTP middlewares</param>
        /// </summary>
        public RequestInfo CreatePostRequestInfo(MailFolder body, Action<IDictionary<string, string>> h = default, IEnumerable<IMiddlewareOption> o = default) {
