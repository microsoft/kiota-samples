...
module Graphrubyv4::Utilities::Users::InferenceClassification::Overrides
    ## 
    ...
    class OverridesRequestBuilder
        ...
        @path_segment
        ## 
        # Gets an item from the graphrubyv4.utilities.users.inferenceClassification.overrides collection
        def [](position)
