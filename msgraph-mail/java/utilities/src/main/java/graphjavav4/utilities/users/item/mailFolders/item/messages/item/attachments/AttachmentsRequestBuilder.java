...
public class AttachmentsRequestBuilder {
     ...
     * @return a void
     */
    public AttachmentsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, String> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
