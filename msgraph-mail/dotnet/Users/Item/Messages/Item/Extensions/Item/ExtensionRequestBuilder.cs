...
namespace Graphdotnetv4.Users.Item.Messages.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        /// </summary>
        public ExtensionRequestBuilder(Dictionary<string, string> urlTemplateParameters, IRequestAdapter requestAdapter) {
