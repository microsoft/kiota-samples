...
attachments_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.messages.item.attachments.attachments_request_builder')
attachment_item_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.messages.item.attachments.item.attachment_item_request_builder')
extensions_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.messages.item.extensions.extensions_request_builder')
extension_item_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.messages.item.extensions.item.extension_item_request_builder')
multi_value_extended_properties_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.messages.item.multi_value_extended_properties.multi_value_extended_properties_request_builder')
multi_value_legacy_extended_property_item_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.messages.item.multi_value_extended_properties.item.multi_value_legacy_extended_property_item_request_builder')
single_value_extended_properties_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.messages.item.single_value_extended_properties.single_value_extended_properties_request_builder')
single_value_legacy_extended_property_item_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.messages.item.single_value_extended_properties.item.single_value_legacy_extended_property_item_request_builder')
content_request_builder = lazy_import('graph_pythonv1.users.item.mail_folders.item.messages.item.value.content_request_builder')
