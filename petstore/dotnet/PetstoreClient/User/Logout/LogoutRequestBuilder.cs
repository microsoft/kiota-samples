...
namespace KiotaSamples.PetStoreSdk.User.Logout {
    /// <summary>Builds and executes requests for operations under \user\logout</summary>
    public class LogoutRequestBuilder {
        ...
        public LogoutRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/user/logout";
        ...
        public RequestInformation CreateGetRequestInformation(Action<LogoutRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        public async Task<Stream> GetAsync(Action<LogoutRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
