...
using Graphdotnetv4.Users.Item.InferenceClassification.Overrides.Item;
...
namespace Graphdotnetv4.Users.Item.InferenceClassification.Overrides {
    ...
    public class OverridesRequestBuilder {
        ...
        /// </summary>
        public async Task<OverridesResponse> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
