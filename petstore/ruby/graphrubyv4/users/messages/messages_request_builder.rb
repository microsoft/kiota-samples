...
module Graphrubyv4::Users::Messages
    ...
    class MessagesRequestBuilder
        ...
        def get(q=nil, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Messages::MessagesResponse, response_handler)
        end
        ## 
        ## Create new navigation property to messages for users
        ## @param body 
        ...
        def post(body, h=nil, o=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, Graphrubyv4::Users::Messages::Message, response_handler)
        end
    end
end
