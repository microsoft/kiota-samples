...
public class MultiValueLegacyExtendedPropertyRequestBuilder {
     ...
     * @return a void
     */
    public MultiValueLegacyExtendedPropertyRequestBuilder(final String currentPath, final RequestAdapter requestAdapter) {
     ...
     * @return a void
     */
    public MultiValueLegacyExtendedPropertyRequestBuilder(@javax.annotation.Nonnull final String currentPath, @javax.annotation.Nonnull final RequestAdapter requestAdapter, final boolean isRawUrl) {
