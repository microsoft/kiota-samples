...
mail_folder_collection_response = lazy_import('graph_pythonv1.models.mail_folder_collection_response')
...
class ChildFoldersRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[ChildFoldersRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[mail_folder_collection_response.MailFolderCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, mail_folder_collection_response.MailFolderCollectionResponse, response_handler, None)
