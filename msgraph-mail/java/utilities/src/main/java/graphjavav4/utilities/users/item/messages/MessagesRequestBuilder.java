...
public class MessagesRequestBuilder {
     ...
     * @return a void
     */
    public MessagesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, String> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
