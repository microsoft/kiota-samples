...
namespace Graphdotnetv4.Users.MailFolders.Messages.Attachments.Item {
    ...
    public class AttachmentRequestBuilder {
        ...
        /// </summary>
        public RequestInfo CreatePatchRequestInfo<T>(T body, Action<IDictionary<string, string>> h = default) where T : Attachment, IParsable<T>, new(){
            var requestInfo = new RequestInfo {
        ...
        /// <typeparam name="T">The generic type for the model, must inherit Attachment</typeparam>
        /// </summary>
        public async Task<T> GetAsync<T>(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IResponseHandler responseHandler = default) where T : Attachment, IParsable<T>, new(){
        ...
        /// <typeparam name="T">The generic type for the model, must inherit Attachment</typeparam>
        /// </summary>
        public async Task PatchAsync<T>(T body, Action<IDictionary<string, string>> h = default, IResponseHandler responseHandler = default) where T : Attachment, IParsable<T>, new(){
