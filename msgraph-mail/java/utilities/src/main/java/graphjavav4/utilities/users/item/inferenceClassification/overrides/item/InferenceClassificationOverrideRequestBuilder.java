...
public class InferenceClassificationOverrideRequestBuilder {
     ...
     * @return a void
     */
    public InferenceClassificationOverrideRequestBuilder(@javax.annotation.Nonnull final HashMap<String, String> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
