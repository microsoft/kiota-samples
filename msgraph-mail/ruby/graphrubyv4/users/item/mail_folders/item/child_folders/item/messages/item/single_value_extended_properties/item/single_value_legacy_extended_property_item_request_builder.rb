...
module GraphC::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::SingleValueExtendedProperties::Item
    ## 
    ...
    class SingleValueLegacyExtendedPropertyItemRequestBuilder
        ...
        def get(request_configuration=nil, response_handler=nil) 
            ...
            return @http_core.send_async(request_info, GraphC::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedProperty, response_handler)
        end
        ## 
        ## Update the navigation property singleValueExtendedProperties in users
        ## @param body 
